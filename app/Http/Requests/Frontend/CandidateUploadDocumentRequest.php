...
class CandidateUploadDocumentRequest extends FormRequest
{
    /**
    ...
    {       
        return [
            'selected'              => ['required',new UploadDocumentNameValidation],
            'attachment'            => 'nullable|mimes:jpeg,jpg,png,gif,bmp,psd,doc,docx,xls,xlsx,zip,rar,ppt,pptx,pdf,application/pdf,mp3|min:2|max:1024', 
        ];       
    }
