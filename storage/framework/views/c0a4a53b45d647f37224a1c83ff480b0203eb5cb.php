      ...
      <div class="modal-body">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="password" autocomplete="off" class="form-control" id="current_password"  name="current_password" maxlength="20" value="<?php echo e(old('current_password')); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="password" autocomplete="off" class="form-control" id="new_password"  name="new_password" maxlength="20" value="<?php echo e(old('new_password')); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="password" autocomplete="off" class="form-control" id="new_confirm_password"  name="new_confirm_password" maxlength="20" value="<?php echo e(old('new_confirm_password')); ?>">
  ...
  <script>
         jQuery(document).ready(function(){
            jQuery('#ajaxSubmit').click(function(e){
               ...
               jQuery.ajax({
                  url: "<?php echo e(route('change.password.perform')); ?>",
                  method: 'post',
                  data: {
      ...
      </script><?php /**PATH C:\wamp\www\career\resources\views/frontend/includes/modals/change-password.blade.php ENDPATH**/ ?>